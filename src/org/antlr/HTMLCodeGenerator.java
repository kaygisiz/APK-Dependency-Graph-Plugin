...
public void gen(AlternativeBlock blk) {
	...
	public void gen(LexerGrammar g) throws IOException {
		...
		currentOutput = org.antlr.Tool.openOutputFile(grammar.getClassName() + TokenTypesFileExt);
...
public void gen(OneOrMoreBlock blk) {
	...
	public void gen(ParserGrammar g) throws IOException {
		...
		currentOutput = org.antlr.Tool.openOutputFile(grammar.getClassName()+".html");
	...
	public  void gen(TreeWalkerGrammar g) throws IOException {
		...
		currentOutput = org.antlr.Tool.openOutputFile(grammar.getClassName()+".txt");
		//SAS: changed for proper text file io
...
protected void genGenericBlock(AlternativeBlock blk, String blkOp) {
	...
	*/
	...
	protected void genTokenTypes(TokenManager tm) throws IOException {
		...
		currentOutput = org.antlr.Tool.openOutputFile(tm.getName() + TokenTypesFileSuffix+TokenTypesFileExt);
		//SAS: changed for proper text file io
		tabs = 0;
