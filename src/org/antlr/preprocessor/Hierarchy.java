 ...
 *
 * $Id: //depot/code/org.antlr/release/antlr-2.7.0/antlr/preprocessor/Hierarchy.java#1 $
 */
...
public class Hierarchy {
	...
	public void readGrammarFile(String file) throws FileNotFoundException {
		...
		try {
			...
			org.antlr.Tool.toolError("Token stream error reading grammar(s):"+io);
		}
		catch (ANTLRException se) {
			org.antlr.Tool.toolError("error reading grammar(s):"+se);
		}
	}
	...
	public boolean verifyThatHierarchyIsComplete() {
		...
		for (Enumeration e = symbols.elements() ; e.hasMoreElements() ;) {
			...
			if ( superG == null ) {
				org.antlr.Tool.toolError("grammar "+c.getSuperGrammarName()+" not defined");
				complete = false;
