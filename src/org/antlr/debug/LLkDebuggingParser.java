...
import org.antlr.debug.ParserEventSupport;
...
public class LLkDebuggingParser extends LLkParser implements DebuggingParser {
	...
	protected void setupDebugging(TokenStream lexer, TokenBuffer tokenBuf) {
		...
		try {
			...
			Constructor constructor = c.getConstructor(LLkDebuggingParser.class, TokenStream.class, TokenBuffer.class);
			constructor.newInstance(this, lexer, tokenBuf);
		}
		catch(Exception e) {
