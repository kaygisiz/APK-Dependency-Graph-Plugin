 ...
 *
 * $Id: //depot/code/org.antlr/release/antlr-2.7.0/antlr/JavaCodeGenerator.java#1 $
 */
...
public class JavaCodeGenerator extends CodeGenerator {
	...
	public  void gen(LexerGrammar g) throws IOException {
		...
		println("import org.antlr.TokenStreamException;");
		println("import org.antlr.TokenStreamIOException;");
		println("import org.antlr.TokenStreamRecognitionException;");
		println("import org.antlr.CharStreamException;");
		println("import org.antlr.CharStreamIOException;");
		println("import org.antlr.ANTLRException;");
		println("import java.io.Reader;");
		println("import java.util.Hashtable;");
		println("import org.antlr." + grammar.getSuperClass() + ";");
		println("import org.antlr.InputBuffer;");
		println("import org.antlr.ByteBuffer;");
		println("import org.antlr.CharBuffer;");
		println("import org.antlr.Token;");
		println("import org.antlr.CommonToken;");
		println("import org.antlr.RecognitionException;");
		println("import org.antlr.NoViableAltForCharException;");
		println("import org.antlr.MismatchedCharException;");
		println("import org.antlr.TokenStream;");
		println("import org.antlr.ANTLRHashString;");
		println("import org.antlr.LexerSharedInputState;");
		println("import org.antlr.collections.impl.BitSet;");
		println("import org.antlr.SemanticException;");
		...
		if (grammar.debuggingOutput)
			println("this(new LexerSharedInputState(new org.antlr.debug.DebuggingInputBuffer(ib)));");
		else
	...
	public void gen(ParserGrammar g) throws IOException {
		...
		println("import org.antlr.TokenBuffer;");
		println("import org.antlr.TokenStreamException;");
		println("import org.antlr.TokenStreamIOException;");
		println("import org.antlr.ANTLRException;");
		println("import org.antlr." + grammar.getSuperClass() + ";");
		...
		println("import org.antlr.TokenStream;");
		println("import org.antlr.RecognitionException;");
		println("import org.antlr.NoViableAltException;");
		println("import org.antlr.MismatchedTokenException;");
		println("import org.antlr.SemanticException;");
		println("import org.antlr.ParserSharedInputState;");
		println("import org.antlr.collections.impl.BitSet;");
		println("import org.antlr.collections.AST;");
		println("import org.antlr.ASTPair;");
		println("import org.antlr.collections.impl.ASTArray;");
		...
		for (int i = 0; i < v.size(); i++)
		{
			...
			if ( !s.startsWith("\"") && !s.startsWith("<") ) {
				...
				if ( ts!=null && ts.getParaphrase()!=null ) {
					s = org.antlr.Tool.stripFrontBack(ts.getParaphrase(), "\"", "\"");
				}
			}	
		...
		for (int i = Token.MIN_USER_TYPE; i < v.size(); i++) {
			...
			if (s != null) {
				if ( s.startsWith("\"") ) {
					...
					if ( sl==null ) {
						org.antlr.Tool.panic("String literal "+s+" not in symbol table");
					}
...
*/
	...
	private String mangleLiteral(String s) {
		String mangled = org.antlr.Tool.literalsPrefix;
		...
		if ( org.antlr.Tool.upperCaseMangledLiterals ) {
	...
	public void setupOutput(String className) throws IOException {
		currentOutput = org.antlr.Tool.openOutputFile(className + ".java");
	}
}
