 ...
 *
 * $Id: //depot/code/org.antlr/release/antlr-2.7.0/antlr/SatherCodeGenerator.java#1 $
 */
...
public class SatherCodeGenerator extends CodeGenerator 
{
	...
	*/
	...
	if ( rblk.argAction != null || rblk.returnAction != null )
	    if ( !hasArgs ) {
		hasArgs = true;
		_print("( ");
	    }
	...
	*/
	...
	currentOutput = org.antlr.Tool.openOutputFile(className + ".sa");
    }
	...
	for (int i = s_length - 1 ; i >=0 ; i-- )  {
	    if ( s.charAt(i) == ':' ) {
		return s.substring( i+1 , s_length - 1 );
	    }
	}
	...
	if ( (grammar.buildAST && actionStr.indexOf('@') != -1) ||
	    ...
	    org.antlr.actions.sather.ActionLexer lexer =
		new org.antlr.actions.sather.ActionLexer(actionStr, currentRule, this, tInfo);
		...
		org.antlr.Tool.panic("Error reading action:"+actionStr);
		return actionStr;
	    }
