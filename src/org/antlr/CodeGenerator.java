 ...
 * @version 2.00a
 * @see     org.antlr.JavaCodeGenerator
 * @see     org.antlr.DiagnosticCodeGenerator
 * @see     org.antlr.LLkAnalyzer
 * @see     org.antlr.Grammar
 * @see     org.antlr.AlternativeElement
 * @see     org.antlr.Lookahead
 */
public abstract class CodeGenerator {
	...
	currentOutput = org.antlr.Tool.openOutputFile(fName);
	...
	if ( (grammar.buildAST && actionStr.indexOf('#') != -1) ||
	    ...
	    org.antlr.actions.java.ActionLexer lexer = new org.antlr.actions.java.ActionLexer(actionStr, currentRule, this, tInfo);
