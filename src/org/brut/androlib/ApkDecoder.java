...
import org.brut.androlib.err.InFileNotFoundException;
import org.brut.androlib.err.OutDirExistsException;
import org.brut.androlib.err.UndefinedResObject;
...
public class ApkDecoder {
    ...
    public void decode() throws AndrolibException, IOException, DirectoryException {
        try {
            ...
            String message = "Using Apktool " + Androlib.getVersion() + " on " + mApkFile.getName();
            LOGGER.info(message);
            ProgressManager.getInstance().getProgressIndicator().setText(message);
