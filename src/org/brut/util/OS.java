...
import org.brut.androlib.Androlib;
    ...
    public static void cpdir(File src, File dest) throws BrutException {
        ...
        for (int i = 0; i < files.length; i++) {
            ...
            try {
                ...
                org.apache.xmlbeans.impl.common.IOUtil.copyCompletely(in, out);
                in.close();
                out.close();
            ...
            try {
                ...
                while ((line = br.readLine()) != null) {
                    if (mType.equals("OUTPUT")) {
                        LOGGER.info(line);
                        ProgressManager.getInstance().getProgressIndicator().setText(line);
                    } else {
                        LOGGER.warning(line);
                    }
                }
